...
if __name__ == "__main__":
    side = "left"
    # side = "right"
    filename = "/home/yurii/data/reip_5/camera_calibration/%s/calib_coarse.avi" % side
    dir = "/home/yurii/data/reip_5/camera_calibration/%s/calib_coarse/" % side
    # filename = "/home/yurii/data/reip_5/camera_calibration/%s/calib_fine.avi" % side
    # dir = "/home/yurii/data/reip_5/camera_calibration/%s/calib_fine/" % side

    # Uncomment this section to extract frames for video
    ...
    # img = cv2.imread(dir + "/1100.jpg")
    img = cv2.imread(dir + "/1360.jpg")
    gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
